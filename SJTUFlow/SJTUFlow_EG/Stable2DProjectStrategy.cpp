...
void Stable2DProjectStrategy::project(int N, float * u, float * v, float * p, float * div)
{
    ...
    m_bs->setUpBoundary(N, BounadaryTypeNone, div);
    m_bs->setUpBoundary(N, BounadaryTypeNone, p);
    
    MathHelper::linearCalculation( N, BounadaryTypeNone, p, div, 1, 4 );
    ...
    m_bs->setUpBoundary(N, BounadaryTypeHorizontal, u);
    m_bs->setUpBoundary(N, BounadaryTypeVertical, v);
}
